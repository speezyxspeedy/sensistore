    ...
    <footer className="relative border-t border-white/[0.07] bg-[#04060a] py-10">
      <div className="container-shell grid gap-8 text-center md:grid-cols-[1.2fr_1fr_1fr] md:text-left">
        <div>
          ...
          <a href={import.meta.env.VITE_APP_URL || 'https://sensistore-one.vercel.app'} target="_blank" rel="noreferrer" className="mt-2 inline-block text-[11px] text-lime/70 transition hover:text-lime">sensistore-one.vercel.app</a>
        </div>
