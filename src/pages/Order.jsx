...
export default function Order() {
  ...
  const placeOrder = async (event) => {
    ...
    try {
      ...
      const payment = await createPaymentOrder({ orderId, paymentId: form.paymentId, amount: selectedPlan.price, plan: selectedPlan.id, customerEmail: user.email })
      const order = await createOrder({ user, form, plan: selectedPlan, payment, orderId })
